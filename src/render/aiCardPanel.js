...
function buildAICardStructure(force = false) {
  ...
  body.innerHTML = `
    ...
    <div class="risk-box" aria-label="Risk indicators">
      <div class="risk-title" aria-hidden="true">Risk Indicators</div>
      <div id="implantRiskSection">
        <div class="risk-row">
          <div class="risk-lbl">Peri-implantitis Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0" aria-label="Peri-implantitis risk info">ⓘ</span>
            <span class="tt-pop" role="tooltip">Risk of inflammation around implant<br>based on hygiene &amp; bone quality</span></span>
          </div>
          <div class="risk-val" id="riskPeri" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Bone Loss Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0" aria-label="Bone loss risk info">ⓘ</span>
            <span class="tt-pop" role="tooltip">Likelihood of peri-implant<br>bone resorption over time</span></span>
          </div>
          <div class="risk-val" id="riskBone" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Occlusal Overload
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0" aria-label="Occlusal overload risk info">ⓘ</span>
            <span class="tt-pop" role="tooltip">Excessive bite force risk —<br>night guard recommended</span></span>
          </div>
          <div class="risk-val" id="riskOcc" aria-live="polite">Medium <span role="img" class="dot dot-med" aria-label="Medium risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Smoking Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0" aria-label="Smoking risk info">ⓘ</span>
            <span class="tt-pop" role="tooltip">Active smoking significantly increases<br>implant failure and peri-implantitis risk</span></span>
          </div>
          <div class="risk-val" id="riskSmoking" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row" id="riskDiabetesRow" style="display:none;">
          <div class="risk-lbl">Diabetes Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0" aria-label="Diabetes risk info">ⓘ</span>
            <span class="tt-pop" role="tooltip">Uncontrolled HbA1c ≥7.5% causes<br>2–3× higher implant failure &amp; poor healing</span></span>
          </div>
          <div class="risk-val" id="riskDiabetes" aria-live="polite">Medium <span role="img" class="dot dot-med" aria-label="Medium risk"></span></div>
        </div>
      </div>
      <div id="crownRiskSection" style="display:none;">
        <div class="risk-row">
          <div class="risk-lbl">Secondary Caries Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0">ⓘ</span>
            <span class="tt-pop" role="tooltip">Risk of decay at crown margin.<br>Hygiene is the #1 factor</span></span>
          </div>
          <div class="risk-val" id="riskCaries" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Crown Fracture Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0">ⓘ</span>
            <span class="tt-pop" role="tooltip">Risk of ceramic fracture.<br>Parafunction = 60% failure rate</span></span>
          </div>
          <div class="risk-val" id="riskCrownFrac" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Root Fracture Risk
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0">ⓘ</span>
            <span class="tt-pop" role="tooltip">Risk of vertical root fracture.<br>No ferrule = 60% early failure</span></span>
          </div>
          <div class="risk-val" id="riskRootFrac" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Endodontic Failure
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0">ⓘ</span>
            <span class="tt-pop" role="tooltip">Risk of RCT failure after crown.<br>RCT done = 91.3% survival at 10yr</span></span>
          </div>
          <div class="risk-val" id="riskEndo" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
        <div class="risk-row">
          <div class="risk-lbl">Parafunction Damage
            <span class="tt"><span style="font-size:11px;cursor:help;" tabindex="0">ⓘ</span>
            <span class="tt-pop" role="tooltip">Bruxism/clenching damage.<br>Night guard REQUIRED if present</span></span>
          </div>
          <div class="risk-val" id="riskParafunc" aria-live="polite">Low <span role="img" class="dot dot-low" aria-label="Low risk"></span></div>
        </div>
      </div>
    </div>`;
}
